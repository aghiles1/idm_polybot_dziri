...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>If Object Detected</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link polybot.impl.IfObjectDetectedImpl#getListOfInstructions <em>List Of Instructions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IfObjectDetectedImpl extends InstructionImpl implements IfObjectDetected {
	/**
	 ...
	 * @generated
	 */
	protected IfObjectDetectedImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PolybotPackage.Literals.IF_OBJECT_DETECTED;
	}
	...
	public EList<Instruction> getListOfInstructions() {
		if (listOfInstructions == null) {
			listOfInstructions = new EObjectContainmentEList<Instruction>(Instruction.class, this, PolybotPackage.IF_OBJECT_DETECTED__LIST_OF_INSTRUCTIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PolybotPackage.IF_OBJECT_DETECTED__LIST_OF_INSTRUCTIONS:
