 ...
 * @generated
 */
public class PolybotSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PolybotPackage.INSTRUCTION: {
			...
			case PolybotPackage.REVERSE: {
				...
				if (result == null) result = caseMove(reverse);
				if (result == null) result = caseInstruction(reverse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
