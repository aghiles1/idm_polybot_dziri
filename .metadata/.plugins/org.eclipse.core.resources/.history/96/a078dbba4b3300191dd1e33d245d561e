...
/**
 * This is the item provider adapter for a {@link polybot.Right} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RightItemProvider extends MoveItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return getString("_UI_Right_type") + " " + right.getSpeed();
	}
